...
static final String createApplicant = "INSERT INTO APPLICANT (a_hashedid, a_username, a_fname, a_lname, a_dob) VALUES ('?D(G+KbPeShVmYq3', 'Rockstar Programmer', 'Test', 'Testerson', SYSDATE)";
...
static final String updateAppInfo = "UPDATE APPLICANT SET a_username = 'Dark Lord', a_fname = 'Darth', a_lname = 'Vader', a_dob = SYSDATE WHERE a_hashedid = '?D(G+KbPeShVmYq3';";
