...
static final String createAdmin = "INSERT INTO ADMINISTRATOR (admin_hashedid, admin_username, admin_fname, admin_lname, admin_dob) VALUES ('9z$Cw)J@NcRfUjX', 'Seal Search Admin', 'Sammy', 'Seal', SYSDATE)"; 

static final String updateAdminInfo = "UPDATE ADMINISTRATOR SET admin_username = 'The Creator', admin_fname = 'Spaghetti', admin_lname = 'Monster', admin_dob = SYSDATE WHERE admin_hashedid = '9z$Cw)J@NcRfUjX';";
