...
--
-- Host: thesealsearchserver.mysql.database.azure.com    Database: sealdb
-- ------------------------------------------------------
...
CREATE TABLE `applicant` (
  ...
  `a_followedEmployers` varchar(21844) DEFAULT NULL,
  `a_city` varchar(30) DEFAULT NULL,
  `a_state` varchar(30) DEFAULT NULL,
  `a_phoneNumber` varchar(30) DEFAULT NULL,
  `a_email` varchar(30) DEFAULT NULL,
  `a_profilePicture` longblob,
...
-- Dump completed on 2021-06-09 12:30:22
