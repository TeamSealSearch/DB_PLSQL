...
static final String createEmployer = "INSERT INTO EMPLOYER (e_hashedid, e_companyname, e_username, e_fname, e_lname, e_dob) VALUES (\'Xp2s5v8y/A?D(G+K\', \'Google\', \'The Founder\', \'Larry\', \'Page\', \'2021-01-29\')";
...
static final String updateEmpInfo = "UPDATE EMPLOYER SET e_username = \'The Creator\', e_fname = \'Sergey\', e_lname = \'Brin\', e_dob = \'2021-01-29\' WHERE e_hashedid = \'Xp2s5v8y/A?D(G+K\';";
